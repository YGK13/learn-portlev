...
| "Is prompt engineering still the highest-value AI skill?" | 2-3 | 6a/6b | 01/02 | Framing addition, not a new lesson. M1-9 names "agentic engineering" as the field's current higher-value skill; one paragraph in prompt-engineering/03 recap or ai-workflows/01 opening hook. M3 2026-08 plan item #4. |
