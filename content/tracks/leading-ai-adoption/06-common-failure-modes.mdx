...
This is the organizational version of the [AI Wage Gap](/learn/ai-foundations/what-is-the-ai-wage-gap). It happens when leadership treats AI as a procurement decision rather than a capability-building one. The prevention is the change-management work of this track: deliberate, ongoing, in-the-flow-of-work skill building, treated as central to the initiative rather than as an afterthought to the purchase.
