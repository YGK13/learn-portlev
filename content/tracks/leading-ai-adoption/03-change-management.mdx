...
<Callout type="warning" title="The diagnosis usually runs through a manager who has the same gap">Most CHROs delegate this five-cause diagnosis to managers, and most managers are not equipped to run it. Only half of CHROs are confident in their own managers' ability to guide employees on AI use, and just 57% actually provide AI training for people managers (Gallup Global CHRO Roundtable, n=102 CHROs, fielded February 10 to March 16, 2026). A manager who has not built the skill cannot reliably diagnose "no skill yet" in someone else. Get your managers capable first, or the five-cause diagnosis breaks at the level closest to the work. See [What a CHRO Should Do First with AI →](/learn/leading-ai-adoption/what-a-chro-should-do-first-with-ai) for the related manager-readiness data.</Callout>
