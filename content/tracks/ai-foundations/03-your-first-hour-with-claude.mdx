...
A non-technical executive starts using AI in one hour by opening Claude, bringing one real piece of this week's work, briefing the AI with their role, context, task and format, pushing on the first answer two or three times, then saving what worked into a Project. No training needed. The full walkthrough is below.
</Callout>
...
<Callout type="key" title="Or just talk to it">As of July 2026, Claude's voice mode lets you choose between Opus, Sonnet and Haiku and connects to Gmail, Google Calendar, Slack, Canva and Notion. That means you can brief it, ask it to draft an email or move a meeting, all out loud on your phone instead of typing. The same four-part brief from Step 3 works exactly the same way when you say it (Anthropic, reported by TechCrunch, 2026-07-23).</Callout>
