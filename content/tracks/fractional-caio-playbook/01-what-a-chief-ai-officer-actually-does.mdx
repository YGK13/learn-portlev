...
<Callout type="key">The CAIO mandate in one line: own the organization's AI adoption end to end, meaning the value it produces, the risk it creates and the operating model that makes it stick.</Callout>
