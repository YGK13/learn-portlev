...
<TLDR>
Design draws the visitor in, the words decide whether anything happens. Lead the hero with a specific outcome, not a job title. Replace every adjective with a number, a name or a concrete noun. Write the about as a four-beat positioned story, lead every service with the outcome and make the call to action small and specific.
</TLDR>

<Callout type="key">Specificity beats adjectives every time. Replace experienced and passionate with a number, a name or a concrete noun. A site that reads as facts is a site that is believed.</Callout>
...
<Callout type="example" title="Claim vs evidence">"Experienced executive coach" is a claim. "2,300 executives coached" is evidence. Same fact, different effect. The first asks for trust. The second hands the visitor something they can verify.</Callout>
...
<FlowDiagram steps={[{label:"Where you came from",note:"Relevant background, briefly"},{label:"What you saw or learned",note:"The insight others missed"},{label:"What you do now",note:"Work framed as the response"},{label:"Why it matters to the visitor",note:"Bridge to their situation"}]} caption="The about story in four beats, pointed at the reader, not at you." />
