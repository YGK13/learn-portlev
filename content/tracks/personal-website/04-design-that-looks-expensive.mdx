...
<TLDR>
The difference between a site that looks expensive and one that looks cheap is rarely budget. It is a small set of deliberate decisions: typography with character, generous whitespace, a restrained palette, one real photograph, relentless consistency and a flawless phone view. Replace defaults with choices and a free site reads as a premium one.
</TLDR>
...
<Callout type="warning" title="The slop signals">Default sans-serif, purple-to-blue gradient, soft shadows on everything, evenly-spaced sections, stock photos and generic illustrations. The visitor's eye now reads this combination as "no decision was made here." Avoid all of it.</Callout>
...
<Callout type="key" title="The single biggest lever">If you only have time for one change, change the type. A typeface with character, big confident headings and generous line height does more for perceived quality than any other single decision.</Callout>
...
<FlowDiagram
  steps={[
    { label: "Reject defaults", note: "Choose typeface and palette deliberately" },
    { label: "Push whitespace", note: "Add until slightly too empty, then stop" },
    { label: "One real photo", note: "Genuine, well-lit, professional" },
    { label: "Enforce consistency", note: "Fixed scale, palette and button style" },
    { label: "Phone view first", note: "Most visitors only see this" },
  ]}
  caption="The five moves that take a site from cheap to expensive."
/>
