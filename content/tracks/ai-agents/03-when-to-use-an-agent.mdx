...
Triaging a varied inbox where every message needs a different response. Researching an open question across sources you cannot list in advance. Investigating a problem where each finding determines the next move. That is agent-shaped work: variable, reactive, multi-step.
