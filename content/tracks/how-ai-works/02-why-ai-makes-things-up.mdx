...
<TLDR>
AI hallucination is plausible-but-false output stated with full confidence. It is not a bug, it is the direct consequence of a system that predicts plausible text and never checks truth. The risk concentrates in specifics: citations, quotes, numbers, names and recent facts. Defend with explicit permission to admit uncertainty, grounding in real source material and firm verification of every specific that carries a cost.
</TLDR>
