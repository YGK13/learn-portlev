...
<TLDR>
A large language model is a prediction engine. You give it text, it predicts the next small piece, adds it on and predicts again, building an answer one token at a time. Get this picture right and most of AI's strange behavior, the inventions, the inconsistency, the confident wrong answers, suddenly makes sense, and your decisions about where to use it and where to override it get sharper.
</TLDR>
